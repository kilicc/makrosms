#!/usr/bin/env tsx
/**
 * Supabase Admin Kullanıcı Oluşturma Scripti
 * 
 * Bu script, Supabase client kullanarak admin rolünde bir kullanıcı oluşturur.
 */
...
async function createAdminUser() {
  ...
  try {
    ...
    if (existingUsers && existingUsers.length > 0) {
      ...
      console.log('📋 Güncellenmiş Admin Kullanıcı Bilgileri:');
    ...
    console.error('\n❌ Admin kullanıcı oluşturma hatası!\n');
